...
namespace detail
{
    ...
    struct serializer<type_prop::not_a_fundamental, ser_method::use_internal_serializer, F, T>
    {
        ...
        static Archive& save(Archive& ar, const ufo::uintBig_t<nBytes_>& val)
        {
            ar & val.m_pData;
            return ar;
        }
        ...
        template<typename Archive, uint32_t nBytes_>
        static Archive& load(Archive& ar, ufo::uintBig_t<nBytes_>& val)
        {
            ar & val.m_pData;
            return ar;
        }

		/// ufo::FourCC serialization
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::FourCC& val)
		{
			ar & ufo::uintBigFrom(val.V);
			return ar;
		}

		template<typename Archive>
		static Archive& load(Archive& ar, ufo::FourCC& val)
		{
			ufo::uintBigFor<uint32_t>::Type x;
			ar & x;
			x.Export(val.V);
			return ar;
		}
        ...
        ///////////////////////////////////////////////////////////
        /// Common Ufo serialization adapters
        ///////////////////////////////////////////////////////////

        /// ufo::Input serialization
        template<typename Archive>
        static Archive& save(Archive& ar, const ufo::Input& input)
        {
			uint8_t nFlags =
        ...
        template<typename Archive>
        static Archive& load(Archive& ar, ufo::Input& input)
        {
			uint8_t nFlags;
			ar
				& nFlags
        ...
        /// ufo::Output serialization
        template<typename Archive>
        static Archive& save(Archive& ar, const ufo::Output& output)
        {
			uint8_t nFlags =
				...
				((output.m_AssetID == ufo::Zero) ? 0 : 0x20) |
        ...
        template<typename Archive>
        static Archive& load(Archive& ar, ufo::Output& output)
        {
			uint8_t nFlags;
			ar
				& nFlags
			...
			if (0x20 & nFlags)
				...
				output.m_AssetID = ufo::Zero;

            return ar;
        }

		/// ufo::TxKernel::HashLock serialization
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::TxKernel::HashLock& val)
		{
			ar
				& val.m_Preimage
				;
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::TxKernel::HashLock& val)
		{
			ar
				& val.m_Preimage
				;
		...
		/// ufo::TxKernel::RelativeLock serialization
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::TxKernel::RelativeLock& val)
		{
			ar
				& val.m_ID
				& val.m_LockHeight
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::TxKernel::RelativeLock& val)
		{
			ar
				& val.m_ID
				& val.m_LockHeight
        ...
        /// ufo::TxKernel serialization
        template<typename Archive>
        static Archive& save(Archive& ar, const ufo::TxKernel& val)
        {
			uint8_t nFlags2 =
			...
			uint8_t nFlags =
				...
				((val.m_Height.m_Max != ufo::Height(-1)) ? 8 : 0) |
			...
			if (8 & nFlags)
			{
				ufo::Height dh = val.m_Height.m_Max - val.m_Height.m_Min;
				ar & dh;
			}
			if (0x20 & nFlags)
				ar & *val.m_pHashLock;
        ...
        template<typename Archive>
        static Archive& load_Recursive(Archive& ar, ufo::TxKernel& val, uint32_t nRecusion)
        {
			uint8_t nFlags;
			ar
				& nFlags
			...
			if (8 & nFlags)
			{
				...
				val.m_Height.m_Max = ufo::Height(-1);

			val.m_Signature.m_NoncePub.m_Y = ((0x10 & nFlags) != 0);

			if (0x20 & nFlags)
			{
				val.m_pHashLock.reset(new ufo::TxKernel::HashLock);
				ar & *val.m_pHashLock;
			}

			if (0x40 & nFlags)
			{
				ufo::TxKernel::TestRecursion(++nRecusion);
				...
				for (uint32_t i = 0; i < nCount; i++)
				{
					std::unique_ptr<ufo::TxKernel>& v = val.m_vNested[i];
					v = std::make_unique<ufo::TxKernel>();
			...
			if (0x80 & nFlags)
			{
				...
				if (2 & nFlags2)
				{
					val.m_pRelativeLock.reset(new ufo::TxKernel::RelativeLock);
					ar & *val.m_pRelativeLock;
				}
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::TxKernel& val)
		{
			return load_Recursive(ar, val, 0);
		}

        /// ufo::Transaction serialization
        template<typename Archive>
        static Archive& save(Archive& ar, const ufo::TxBase& txb)
        {
            ar
				& txb.m_Offset;
        ...
        template<typename Archive>
        static Archive& load(Archive& ar, ufo::TxBase& txb)
        {
            ar
				& txb.m_Offset;
        ...
        template<typename Archive>
        static Archive& save(Archive& ar, const ufo::TxVectors::Perishable& txv)
        {
        ...
        template<typename Archive>
        static Archive& load(Archive& ar, ufo::TxVectors::Perishable& txv)
        {
		...
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::TxVectors::Eternal& txv)
		{
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::TxVectors::Eternal& txv)
		{
		...
		template<typename Archive>
        static Archive& save(Archive& ar, const ufo::Transaction& tx)
        {
			ar
				& Cast::Down<ufo::TxVectors::Perishable>(tx)
				& Cast::Down<ufo::TxVectors::Eternal>(tx)
				& Cast::Down<ufo::TxBase>(tx);

            return ar;
        }

        template<typename Archive>
        static Archive& load(Archive& ar, ufo::Transaction& tx)
        {
			ar
				& Cast::Down<ufo::TxVectors::Perishable>(tx)
				& Cast::Down<ufo::TxVectors::Eternal>(tx)
		...
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::Block::PoW& pow)
		{
			ar
				//& pow.m_Indices
				& pow.m_Difficulty.nBitsPow
				& pow.m_Nonce;
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::Block::PoW& pow)
		{
			ar
				//& pow.m_Indices
				& pow.m_Difficulty.nBitsPow
		...
		template<typename Archive>
        static Archive& save(Archive& ar, const ufo::Block::SystemState::ID& v)
        {
            ar
				& v.m_Height
				& v.m_Hash;
        ...
        template<typename Archive>
        static Archive& load(Archive& ar, ufo::Block::SystemState::ID& v)
        {
			ar
				& v.m_Height
				& v.m_Hash;
		...
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::Block::SystemState::Sequence::Prefix& v)
		{
			ar
				& v.m_Height
				& v.m_Prev
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::Block::SystemState::Sequence::Prefix& v)
		{
			ar
				& v.m_Height
				& v.m_Prev
		...
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::Block::SystemState::Sequence::Element& v)
		{
			ar
				& v.m_Kernels
				& v.m_Definition
		...
		template<typename Archive>
		static Archive& load(Archive& ar, ufo::Block::SystemState::Sequence::Element& v)
		{
			ar
				& v.m_Kernels
				& v.m_Definition
		...
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::Block::SystemState::Full& v)
		{
			save(ar, Cast::Down<ufo::Block::SystemState::Sequence::Prefix>(v));
			save(ar, Cast::Down<ufo::Block::SystemState::Sequence::Element>(v));

			return ar;
		}

		template<typename Archive>
		static Archive& load(Archive& ar, ufo::Block::SystemState::Full& v)
		{
			load(ar, Cast::Down<ufo::Block::SystemState::Sequence::Prefix>(v));
			load(ar, Cast::Down<ufo::Block::SystemState::Sequence::Element>(v));

			return ar;
		}

		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::Block::BodyBase& bb)
		{
			ar & Cast::Down<ufo::TxBase>(bb);
			return ar;
		}

		template<typename Archive>
		static Archive& load(Archive& ar, ufo::Block::BodyBase& bb)
		{
			ar & Cast::Down<ufo::TxBase>(bb);
			return ar;
		}
		...
		template<typename Archive>
		static Archive& save(Archive& ar, const ufo::Block::Body& bb)
		{
			ar & Cast::Down<ufo::Block::BodyBase>(bb);
			ar & Cast::Down<ufo::TxVectors::Perishable>(bb);
			ar & Cast::Down<ufo::TxVectors::Eternal>(bb);

			return ar;
		}

		template<typename Archive>
		static Archive& load(Archive& ar, ufo::Block::Body& bb)
		{
			ar & Cast::Down<ufo::Block::BodyBase>(bb);
			ar & Cast::Down<ufo::TxVectors::Perishable>(bb);
			ar & Cast::Down<ufo::TxVectors::Eternal>(bb);
