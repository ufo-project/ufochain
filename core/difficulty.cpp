...
namespace ufo
{
    ...
    void Difficulty::Pack(const arith_uint256& target)
    {
    ...
    void Difficulty::Unpack(arith_uint256& target) const
    {
        bool fNegative;
        bool fOverflow;
    ...
    bool Difficulty::get_Target(arith_uint256& bnTarget) const
    {
        bool fNegative;
        bool fOverflow;
    ...
    void Difficulty::Pack(const Raw& res)
    {
    ...
    */
    ...
    // use nbits 0x1e00ffff as difficulty 1
    double Difficulty::ToFloat() const
    {
