...
namespace ECC
{
	...
	inline void GenRandom(ufo::uintBig_t<nBytes_>& x) { GenRandom(x.m_pData, x.nBytes); }
	...
	typedef ufo::uintBig_t<nBytes> uintBig;
...
#pragma pack (push, 1)
			struct Packed
			{
				ufo::uintBigFor<uint64_t>::Type m_Idx;
				ufo::uintBigFor<uint32_t>::Type m_Type;
				ufo::uintBigFor<uint32_t>::Type m_SubIdx;
...
#pragma pack (push, 1)
			struct Packed
				:public ID::Packed
			{
				ufo::uintBigFor<Amount>::Type m_Value;
