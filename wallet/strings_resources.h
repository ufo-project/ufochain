...
namespace ufo
{
    ...
    extern const char kSwapTxStatusBuildingUfoLockTX[];
    extern const char kSwapTxStatusBuildingUfoRefundTX[];
    extern const char kSwapTxStatusBuildingUfoRedeemTX[];
    ...
    extern const char kSwapTxStatusSendingUfoLockTX[];
    extern const char kSwapTxStatusSendingUfoRefundTX[];
    extern const char kSwapTxStatusSendingUfoRedeemTX[];
