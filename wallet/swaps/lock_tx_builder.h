...
namespace ufo::wallet
{
    ...
    public:
        ...
        bool CreateSharedUTXOProofPart2(bool isUfoOwner);
        bool CreateSharedUTXOProofPart3(bool isUfoOwner);
    ...
    private:
        ...
        const ECC::RangeProof::CreatorParams& GetProofCreatorParams(bool isUfoOwner);
