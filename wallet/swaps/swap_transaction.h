...
namespace ufo::wallet
{
    ...
    public:
        ...
        virtual SecondSide::Ptr CreateSecondSide(BaseTransaction& tx, bool isUfoSide) = 0;
    };
    ...
    private:
        SecondSide::Ptr CreateSecondSide(BaseTransaction& tx, bool isUfoSide) override
        {
            return std::make_shared<BridgeSide>(tx, m_bridgeCreator(), m_settingsProvider, isUfoSide);
        }
    private:
    ...
    private:
        ...
        SubTxState BuildUfoLockTx();
        SubTxState BuildUfoWithdrawTx(SubTxID subTxID, Transaction::Ptr& resultTx);
        bool CompleteUfoWithdrawTx(SubTxID subTxID);
        ...
        mutable boost::optional<bool> m_IsUfoSide;
        mutable boost::optional<bool> m_IsSender;
        mutable boost::optional<ufo::Amount> m_Amount;
