...
namespace std
{
    ...
    string to_string(ufo::wallet::AtomicSwapCoin value)
    {
        switch (value)
        {
    ...
    string to_string(ufo::wallet::SwapOfferStatus status)
    {
        switch (status)
        {
        case ufo::wallet::SwapOfferStatus::Pending:
            return "Pending";
        case ufo::wallet::SwapOfferStatus::InProgress:
            return "InProgress";
        case ufo::wallet::SwapOfferStatus::Completed:
            return "Completed";
        case ufo::wallet::SwapOfferStatus::Canceled:
            return "Canceled";
        case ufo::wallet::SwapOfferStatus::Expired:
            return "Expired";
        case ufo::wallet::SwapOfferStatus::Failed:
            return "Failed";
    ...
    string to_string(const ufo::wallet::PrintableAmount& amount)
    {
        stringstream ss;
        ...
        else
        {
            ...
            {
                ss << Amount(amount.m_value / Rules::Coin) << " ufos ";
            }
    ...
    string to_string(const ufo::wallet::TxParameters& value)
    {
        ufo::wallet::TxToken token(value);
        Serializer s;
        s & token;
        ByteBuffer buffer;
        s.swap_buf(buffer);
        return ufo::wallet::EncodeToBase58(buffer);
    }
}
