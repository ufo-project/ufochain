...
namespace ufo::wallet
{
    ...
    {
    public:
        BitcoinSide(BaseTransaction& tx, bitcoin::IBridge::Ptr bitcoinBridge, bitcoin::ISettingsProvider& settingsProvider, bool isUfoSide);
        virtual ~BitcoinSide();
    ...
    protected:
        virtual uint32_t GetLockTxEstimatedTimeInUfoBlocks() const;
