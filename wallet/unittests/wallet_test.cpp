...
bool RunNegLoop(ufo::Negotiator::IBase& a, ufo::Negotiator::IBase& b, const char* szTask)
{
...
Amount SetKidvs(ufo::Negotiator::IBase& neg, const Amount* p, size_t n, uint32_t code, uint32_t i0 = 0)
{
...
void TestHWCommitment()
{
    ...
    Point comm1, comm2;
    {
        ...
        //ufo::WordList generatedPhrases = {"budget", "focus", "surface", "plug", "dragon", "elephant", "token", "child", "kitchen", "coast", "lounge", "mean" };
        ufo::WordList generatedPhrases = { "copy", "vendor", "shallow", "raven", "coffee", "appear", "book", "blast", "lock", "exchange", "farm", "glue" };
        
        auto buf = ufo::decodeMnemonic(generatedPhrases);
...
int main()
{
    ...
    auto logger = ufo::Logger::create(logLevel, logLevel, logLevel, "wallet_test", path.string());
