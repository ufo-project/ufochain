...
public:
	...
	using Callback = std::function<void(bool, ufo::Height)>;
public:
...
protected:
    ...
    void OnMsg(ufo::proto::Authentication&&) override;
	void OnDisconnect(const DisconnectReason&) override;
	void OnMsg(ufo::proto::NewTip&&) override;
	void OnMsg(ufo::proto::ProofUtxo&&) override;
...
protected:
	...
	bool m_IsOk;
	ufo::Height m_Maturity;
	ufo::Block::SystemState::Full m_Hdr;
