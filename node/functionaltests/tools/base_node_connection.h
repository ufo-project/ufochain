...
class BaseNodeConnection : public ufo::proto::NodeConnection
{
public:
...
protected:
	ufo::io::Reactor::Ptr m_Reactor;
	ufo::io::Reactor::Scope m_Scope;
	ufo::io::Timer::Ptr m_Timer;
	bool m_Failed;
