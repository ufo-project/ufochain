...
Node::Peer* Node::AllocPeer(const ufo::io::Address& addr)
{
...
void Node::Initialize(IExternalPOW* externalPOW)
{
    ...
    // +++++++++++++++++++++++++++
    const Keys& keys = m_Miner.get_ParentObj().m_Keys;
    ...
    m_Miner.StartMining(std::move(pTask));
    // +++++++++++++++++++++++++++
...
void Node::Peer::OnMsg(proto::GetProofChainWork&& msg)
{
    ...
    if (!p.IsFastSync() && p.BuildCwp())
    {
        ...
        UFO_VERIFY(msgOut.m_Proof.Crop(p.m_Cwp));
    }
