...
namespace
{
    ...
    void initLogger(const string& appData, const string& appVersion)
    {
        ...
        LOG_INFO() << "Ufo Mobile Wallet " << appVersion << " (" << BRANCH_NAME << ") library: " << PROJECT_VERSION;
...
JNIEXPORT jobject JNICALL UFO_JAVA_API_INTERFACE(createWallet)(JNIEnv *env, jobject thiz, 
...
JNIEXPORT jboolean JNICALL UFO_JAVA_API_INTERFACE(isWalletInitialized)(JNIEnv *env, jobject thiz, 
    jstring appData)
{
...
JNIEXPORT void JNICALL UFO_JAVA_API_INTERFACE(closeWallet)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL UFO_JAVA_API_INTERFACE(isWalletRunning)(JNIEnv *env, jobject thiz)
{
    return walletModel != nullptr;
}

JNIEXPORT jobject JNICALL UFO_JAVA_API_INTERFACE(openWallet)(JNIEnv *env, jobject thiz, 
...
JNIEXPORT jobject JNICALL UFO_JAVA_API_INTERFACE(createMnemonic)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jobject JNICALL UFO_JAVA_API_INTERFACE(getDictionary)(JNIEnv *env, jobject thiz)
{
    //auto phrases = ufo::createMnemonic(ufo::getEntropy(), ufo::language::en);
...
JNIEXPORT jobject JNICALL UFO_JAVA_API_INTERFACE(getDefaultPeers)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT jboolean JNICALL UFO_JAVA_API_INTERFACE(checkReceiverAddress)(JNIEnv *env, jobject thiz, jstring address)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(getWalletStatus)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(getUtxosStatus)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(syncWithNode)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(sendMoney)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(calcChange)(JNIEnv *env, jobject thiz,
    jlong amount)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(getAddresses)(JNIEnv *env, jobject thiz,
    jboolean own)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(generateNewAddress)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(saveAddress)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(importRecovery)(JNIEnv *env, jobject thiz, jstring jpath)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(updateAddress)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(saveAddressChanges)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(cancelTx)(JNIEnv *env, jobject thiz,
    jstring txId)
{
    LOG_DEBUG() << "cancelTx()";
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(deleteTx)(JNIEnv *env, jobject thiz,
    jstring txId)
{
    LOG_DEBUG() << "deleteTx()";
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(deleteAddress)(JNIEnv *env, jobject thiz,
    jstring walletID)
{
    WalletID id(Zero);
...
JNIEXPORT jboolean JNICALL UFO_JAVA_WALLET_INTERFACE(checkWalletPassword)(JNIEnv *env, jobject thiz,
    jstring password)
{
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(changeWalletPassword)(JNIEnv *env, jobject thiz,
    jstring password)
{
    auto pass = JString(env, password).value();
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(getPaymentInfo)(JNIEnv *env, jobject thiz,
    jstring txID)
{
    auto buffer = from_hex(JString(env, txID).value());
    TxID id;
...
JNIEXPORT jobject JNICALL UFO_JAVA_WALLET_INTERFACE(verifyPaymentInfo)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(getCoinsByTx)(JNIEnv *env, jobject thiz,
    jstring txID)
{
    auto buffer = from_hex(JString(env, txID).value());
    TxID id;
...
JNIEXPORT void JNICALL UFO_JAVA_WALLET_INTERFACE(changeNodeAddress)(JNIEnv *env, jobject thiz,
    jstring address)
{
...
JNIEXPORT jstring JNICALL UFO_JAVA_WALLET_INTERFACE(exportOwnerKey)(JNIEnv *env, jobject thiz,
    jstring pass)
{
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/listeners/WalletListener");
        WalletListenerClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/Wallet");
        WalletClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/dto/WalletStatusDTO");
        WalletStatusClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/dto/SystemStateDTO");
        SystemStateClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/dto/TxDescriptionDTO");
        TxDescriptionClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/dto/UtxoDTO");
        UtxoClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/dto/WalletAddressDTO");
        WalletAddressClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
        env->DeleteLocalRef(cls);
    }

    {
        jclass cls = env->FindClass(UFO_JAVA_PATH "/entities/dto/PaymentInfoDTO");
