...
#define UFO_JAVA_PACKAGE(sep)                     com ## sep ## mw ## sep ## ufo ## sep ## ufowallet ## sep ## core
#define UFO_JAVA_PREFIX                         UFO_JAVA_PACKAGE(_)
#define UFO_JAVA_PATH                             "com/mw/ufo/ufowallet/core" // doesn't work on clang DEF2STR(UFO_JAVA_PACKAGE(/))
#define UFO_JAVA_API_INTERFACE(function)         CONCAT1(UFO_JAVA_PREFIX, Api, function)
#define UFO_JAVA_WALLET_INTERFACE(function)     CONCAT1(UFO_JAVA_PREFIX, entities_Wallet, function)
