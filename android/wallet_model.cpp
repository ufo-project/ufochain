...
void WalletModel::onStatus(const WalletStatus& status)
{
...

    {
        ...
        jfieldID systemStateID = env->GetFieldID(WalletStatusClass, "system", "L" UFO_JAVA_PATH "/entities/dto/SystemStateDTO;");
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onStatus", "(L" UFO_JAVA_PATH "/entities/dto/WalletStatusDTO;)V");
...
void WalletModel::onTxStatus(ChangeAction action, const std::vector<TxDescription>& items)
{
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onTxStatus", "(I[L" UFO_JAVA_PATH "/entities/dto/TxDescriptionDTO;)V");
...
void WalletModel::onAllUtxoChanged(const std::vector<Coin>& utxosVec)
{
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onAllUtxoChanged", "([L" UFO_JAVA_PATH "/entities/dto/UtxoDTO;)V");
...
void WalletModel::onAddresses(bool own, const std::vector<WalletAddress>& addresses)
{
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onAddresses", "(Z[L" UFO_JAVA_PATH "/entities/dto/WalletAddressDTO;)V");
...
void WalletModel::onGeneratedNewAddress(const WalletAddress& address)
{
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onGeneratedNewAddress", "(L" UFO_JAVA_PATH "/entities/dto/WalletAddressDTO;)V");
...
void WalletModel::onPaymentProofExported(const TxID& txID, const ByteBuffer& proof)
{
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onPaymentProofExported", "(Ljava/lang/String;L" UFO_JAVA_PATH "/entities/dto/PaymentInfoDTO;)V");
...
void WalletModel::onCoinsByTx(const std::vector<Coin>& coins)
{
    ...
    jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onCoinsByTx", "([L" UFO_JAVA_PATH "/entities/dto/UtxoDTO;)V");
    env->CallStaticVoidMethod(WalletListenerClass, callback, utxos);
