...
struct LogMessageStub {
    ...
    #define LOG_MESSAGE(LEVEL) if (ufo::Logger::will_log(LEVEL)) ufo::LogMessage(LEVEL, __FILE__, __LINE__, __FUNCTION__)
#else
    #define LOG_MESSAGE(LEVEL) if (ufo::Logger::will_log(LEVEL)) ufo::LogMessage(LEVEL)
#endif
