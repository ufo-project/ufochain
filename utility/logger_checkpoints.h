...
#define CHECKPOINT_CREATE(SIZE) \
    ufo::CheckpointData<SIZE> COMBINE(checkpointData,__LINE__); \
    ufo::Checkpoint COMBINE(checkpoint,__LINE__)(COMBINE(checkpointData,__LINE__).items, SIZE, __FILE__, __LINE__, __FUNCTION__)

#define CHECKPOINT_ADD() assert(ufo::current_checkpoint()); *ufo::current_checkpoint()

#define CHECKPOINT(...) \
    ufo::CheckpointData<NUM_ARGS(__VA_ARGS__)> COMBINE(checkpointData,__LINE__); \
    ufo::Checkpoint COMBINE(checkpoint,__LINE__)(COMBINE(checkpointData,__LINE__).items, NUM_ARGS(__VA_ARGS__), __FILE__, __LINE__, __FUNCTION__); \
