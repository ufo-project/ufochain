...
#else
static const char* AppName = "Ufo Wallet Masternet";
#endif
...
#pragma GCC diagnostic pop
        ...
        ufo::Crash::InstallHandler(appDataDir.filePath(AppName).toStdString().c_str());

#define LOG_FILES_PREFIX "UFO_ui_"

        const auto logFilesPath = appDataDir.filePath(WalletSettings::LogsFolder).toStdString();
        auto logger = ufo::Logger::create(logLevel, logLevel, fileLogLevel, LOG_FILES_PREFIX, logFilesPath);
        ...
        try
        {
            ...
            LOG_INFO() << "Ufo Wallet UI " << PROJECT_VERSION << " (" << BRANCH_NAME << ")";
            ...
            qmlRegisterType<WalletCurrency>("Ufo.Wallet", 1, 0, "Currency");
            qmlRegisterType<StartViewModel>("Ufo.Wallet", 1, 0, "StartViewModel");
            qmlRegisterType<LoadingViewModel>("Ufo.Wallet", 1, 0, "LoadingViewModel");
            qmlRegisterType<MainViewModel>("Ufo.Wallet", 1, 0, "MainViewModel");
            qmlRegisterType<DashboardViewModel>("Ufo.Wallet", 1, 0, "DashboardViewModel");
            qmlRegisterType<WalletViewModel>("Ufo.Wallet", 1, 0, "WalletViewModel");
            qmlRegisterType<UtxoViewStatus>("Ufo.Wallet", 1, 0, "UtxoStatus");
            qmlRegisterType<UtxoViewType>("Ufo.Wallet", 1, 0, "UtxoType");
            qmlRegisterType<UtxoViewModel>("Ufo.Wallet", 1, 0, "UtxoViewModel");
            qmlRegisterType<SettingsViewModel>("Ufo.Wallet", 1, 0, "SettingsViewModel");
            qmlRegisterType<AddressBookViewModel>("Ufo.Wallet", 1, 0, "AddressBookViewModel");
            qmlRegisterType<SwapOffersViewModel>("Ufo.Wallet", 1, 0, "SwapOffersViewModel");
            qmlRegisterType<NotificationsViewModel>("Ufo.Wallet", 1, 0, "NotificationsViewModel");
            qmlRegisterType<HelpViewModel>("Ufo.Wallet", 1, 0, "HelpViewModel");
            qmlRegisterType<MessagesViewModel>("Ufo.Wallet", 1, 0, "MessagesViewModel");
            qmlRegisterType<StatusbarViewModel>("Ufo.Wallet", 1, 0, "StatusbarViewModel");
            qmlRegisterType<ReceiveViewModel>("Ufo.Wallet", 1, 0, "ReceiveViewModel");
            qmlRegisterType<ReceiveSwapViewModel>("Ufo.Wallet", 1, 0, "ReceiveSwapViewModel");
            qmlRegisterType<SendViewModel>("Ufo.Wallet", 1, 0, "SendViewModel");
            qmlRegisterType<SendSwapViewModel>("Ufo.Wallet", 1, 0, "SendSwapViewModel");
            qmlRegisterType<ELSeedValidator>("Ufo.Wallet", 1, 0, "ELSeedValidator");

            qmlRegisterType<AddressItem>("Ufo.Wallet", 1, 0, "AddressItem");
            qmlRegisterType<ContactItem>("Ufo.Wallet", 1, 0, "ContactItem");
            qmlRegisterType<UtxoItem>("Ufo.Wallet", 1, 0, "UtxoItem");
            qmlRegisterType<PaymentInfoItem>("Ufo.Wallet", 1, 0, "PaymentInfoItem");
            qmlRegisterType<WalletDBPathItem>("Ufo.Wallet", 1, 0, "WalletDBPathItem");
            qmlRegisterType<SwapOfferItem>("Ufo.Wallet", 1, 0, "SwapOfferItem");
            qmlRegisterType<SwapOffersList>("Ufo.Wallet", 1, 0, "SwapOffersList");
            qmlRegisterType<TokenBootstrapManager>("Ufo.Wallet", 1, 0, "TokenBootstrapManager");
            
            qmlRegisterType<SortFilterProxyModel>("Ufo.Wallet", 1, 0, "SortFilterProxyModel");
