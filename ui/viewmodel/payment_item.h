...
private:
    ...
    ufo::wallet::storage::PaymentInfo m_paymentInfo;
};
...
class MyPaymentInfoItem : public PaymentInfoItem
{
    Q_OBJECT
public:
    MyPaymentInfoItem(const ufo::wallet::TxID& txID, QObject* parent = nullptr);

private slots:
    void onPaymentProofExported(const ufo::wallet::TxID& txID, const QString& proof);
};
