...
auto TxObject::getTxID() const -> ufo::wallet::TxID
{
    return m_tx.m_txId;
}
...
{
    return ufoui::AmountToString(m_tx.m_amount);
}
...
const ufo::wallet::TxDescription& TxObject::getTxDescription() const
{
    return m_tx;
}

void TxObject::setStatus(ufo::wallet::TxStatus status)
{
...
QString TxObject::getFailureReason() const
{
    ...
    if (getTxDescription().m_status == TxStatus::Failed && getTxDescription().m_txType == ufo::wallet::TxType::Simple)
    {
        QString Reasons[] =
                {
                        //% "Unexpected reason, please send wallet logs to Ufo support"
                        qtTrId("tx-failture-undefined"),
                        //% "Transaction cancelled"
                        qtTrId("tx-failture-cancelled"),
                        //% "Receiver signature in not valid, please send wallet logs to Ufo support"
                        ...
                        //% "Transaction is not valid, please send wallet logs to Ufo support"
                        ...
                        //% "Payment not signed by the receiver, please send wallet logs to Ufo support"
...
void TxObject::setFailureReason(ufo::wallet::TxFailureReason reason)
{
...
void TxObject::update(const ufo::wallet::TxDescription& tx)
{
