...
public slots:
    ...
    void onGetWalletError(ufo::wallet::ErrorType error);
...
private:
    ...
    std::unique_ptr<ufoui::Filter> m_bpsWholeTimeFilter;
    std::unique_ptr<ufoui::Filter> m_bpsWindowedFilter;
    std::unique_ptr<ufoui::Filter> m_estimateFilter;
    
    ufo::Timestamp m_startTimestamp;
    ufo::Timestamp m_lastUpdateTimestamp;
    ufo::Timestamp m_previousUpdateTimestamp;
    int m_estimate;
