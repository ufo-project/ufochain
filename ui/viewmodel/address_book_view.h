...
public:
    ...
    AddressItem() = default;
    AddressItem(const ufo::wallet::WalletAddress&);
    ...
    ufo::Timestamp getCreateTimestamp() const;
    ufo::Timestamp getExpirationTimestamp() const;

private:
    ufo::wallet::WalletAddress m_walletAddress;
};
...
public:
    ContactItem() = default;
    ContactItem(const ufo::wallet::WalletAddress&);
...
public slots:
    void onAddresses(bool own, const std::vector<ufo::wallet::WalletAddress>& addresses);
