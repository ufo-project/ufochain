...
public:
    SwapCoinSettingsItem(SwapCoinClientModel& coinClient, ufo::wallet::AtomicSwapCoin swapCoin);
...
private:
    ...
    void setConnectionType(ufo::bitcoin::ISettings::ConnectionType type);

private:
    ufo::wallet::AtomicSwapCoin m_swapCoin;
    SwapCoinClientModel& m_coinClient;

    boost::optional<ufo::bitcoin::Settings> m_settings;
    int m_feeRate = 0;

    ufo::bitcoin::ISettings::ConnectionType m_connectionType = ufo::bitcoin::ISettings::None;
    QString m_nodeUser;
    QString m_nodePass;
...
public:
    ...
    bool isAllowedUfoMWLinks() const;
