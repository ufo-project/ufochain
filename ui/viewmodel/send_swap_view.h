...
public slots:
    void onChangeCalculated(ufo::Amount change);

private:
    void fillParameters(ufo::wallet::TxParameters parameters);
    void recalcAvailable();

    ufo::Amount _sendAmountGrothes;
    ufo::Amount _sendFeeGrothes;
    Currency     _sendCurrency;
    ufo::Amount _receiveAmountGrothes;
    ufo::Amount _receiveFeeGrothes;
    Currency     _receiveCurrency;
    ufo::Amount _changeGrothes;
