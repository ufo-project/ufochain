...
auto SwapTxObjectList::roleNames() const -> QHash<int, QByteArray>
{
    static const auto roles = QHash<int, QByteArray>
    {
        ...
        { static_cast<int>(Roles::IsUfoSideSwap), "isUfoSideSwap" },
        ...
        { static_cast<int>(Roles::UfoLockTxKernelId), "ufoLockTxKernelId" },
        { static_cast<int>(Roles::UfoRedeemTxKernelId), "ufoRedeemTxKernelId" },
        { static_cast<int>(Roles::UfoRefundTxKernelId), "ufoRefundTxKernelId" }
    };
    return roles;
}
...
auto SwapTxObjectList::data(const QModelIndex &index, int role) const -> QVariant
{
    ...
    switch (static_cast<Roles>(role))
    {
        ...
        case Roles::IsUfoSideSwap:
            return value->isUfoSideSwap();
        ...
        case Roles::UfoLockTxKernelId:
            return value->getUfoLockTxKernelId();

        case Roles::UfoRedeemTxKernelId:
            return value->getUfoRedeemTxKernelId();

        case Roles::UfoRefundTxKernelId:
            return value->getUfoRefundTxKernelId();
