...
public:
    ...
    bool createWallet(const ufo::SecString& seed, const ufo::SecString& pass);

#if defined(UFO_HW_WALLET)
    bool createTrezorWallet(std::shared_ptr<ECC::HKdfPub> ownerKey, const ufo::SecString& pass);
#endif

    bool openWallet(const ufo::SecString& pass);
    bool checkWalletPassword(const ufo::SecString& pass) const;
...
public slots:
    void onStartedNode();
    void onFailedToStartNode(ufo::wallet::ErrorType errorCode);
    void onResetWallet();
...
private:
    ...
    void InitLtcClient();
    void InitQtumClient();
    void onWalledOpened(const ufo::SecString& pass);
...
private:
    ...
    ufo::bitcoin::IBridgeHolder::Ptr m_btcBridgeHolder;
    ufo::bitcoin::IBridgeHolder::Ptr m_ltcBridgeHolder;
    ufo::bitcoin::IBridgeHolder::Ptr m_qtumBridgeHolder;

    WalletModel::Ptr m_wallet;
    ufo::wallet::IPrivateKeyKeeper::Ptr m_keyKeeper;
    NodeModel m_nodeModel;
    WalletSettings& m_settings;
    MessageManager m_messages;
    ECC::NoLeak<ECC::uintBig> m_passwordHash;
    ufo::io::Reactor::Ptr m_walletReactor;
    ufo::wallet::IWalletDB::Ptr m_db;
