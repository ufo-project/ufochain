    ...
    Component {
        ...
        ColumnLayout {
            ...
            AvailablePanel {
                ...
                Layout.preferredWidth: parseFloat(viewModel.ufoSending) > 0 || parseFloat(viewModel.ufoReceiving) > 0 ? parent.width : (parent.width / 2)

                available:         viewModel.ufoAvailable
                locked:            viewModel.ufoLocked
                lockedMaturing:    viewModel.ufoLockedMaturing
                sending:           viewModel.ufoSending
                receiving:         viewModel.ufoReceiving
                receivingChange:   viewModel.ufoReceivingChange
                receivingIncoming: viewModel.ufoReceivingIncoming
            }
            ...
            RowLayout {
                ...
                CustomToolButton {
                	...
                	onClicked: {
                        ...
                        saveTrxDialog.open()
                        saveTrxDialog.txModel = transactionsTable.model
                	}
                }
                CustomToolButton {
                ...
                itemDelegate: Item {
                    Item {
                        ...
                        TableItem {
                            ...
                            onCopyText: UfoGlobals.copyToClipboard(styleData.value)
                        }
                    }
                }
