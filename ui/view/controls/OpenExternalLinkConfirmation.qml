    ...
    contentItem: Item {
        Column {
            ...
            SFText {
                ...
                wrapMode: Text.Wrap
                horizontalAlignment : Text.AlignHCenter
                //% "Ufo Wallet app requires permission to open external link in the browser. This action will expose your IP to the web server. To avoid it, choose -Cancel-. You can change your choice in app setting anytime."
